...
public enum StructureType {
    FEATURE(0, "feature", false, Integer.MAX_VALUE, 25), // 地物
    DESERT_PYRAMID(1, "desert_pyramid", true, Integer.MAX_VALUE, 0), // 沙漠神殿
    JUNGLE_TEMPLE(2, "jungle_temple", true, Integer.MAX_VALUE, 1), // 丛林神庙
    JUNGLE_PYRAMID(2, "jungle_pyramid", true, Integer.MAX_VALUE, 1), // 丛林神庙 (1.13+改名)
    SWAMP_HUT(3, "swamp_hut", true, Integer.MAX_VALUE, 2), // 沼泽小屋
    IGLOO(4, "igloo", true, Integer.MAX_VALUE, 3), // 雪屋
    VILLAGE(5, "village", true, Integer.MAX_VALUE, 4), // 村庄
    OCEAN_RUIN(6, "ocean_ruin", false, Integer.MAX_VALUE, 5), // 海底废墟
    SHIPWRECK(7, "shipwreck", true, Integer.MAX_VALUE, 6), // 沉船
    MONUMENT(8, "monument", true, Integer.MAX_VALUE, 7), // 海底神殿
    MANSION(9, "mansion", true, Integer.MAX_VALUE, 8), // 林地府邸
    OUTPOST(10, "outpost", true, Integer.MAX_VALUE, 9), // 掠夺者前哨站
